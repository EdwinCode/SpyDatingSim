class Stephanie {
    constructor(game) {
        ...
        this.spritesheet = ASSET_MANAGER.getAsset("./sprites/entities/stephanie.png");
...
class Richie {
    constructor(game) {
        ...
        this.spritesheet = ASSET_MANAGER.getAsset("./sprites/richie.png");
    ...
    draw(ctx) {
        ctx.drawImage(this.spritesheet, 0, 0, 200, 200, this.x - this.game.camera.x, this.y + (16 * PARAMS.BLOCKWIDTH) - this.game.camera.y, 4.5 * PARAMS.BLOCKWIDTH, 16 * PARAMS.BLOCKWIDTH);
        super.draw(ctx);
