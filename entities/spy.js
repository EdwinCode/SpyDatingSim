        ...
        this.game.entities.forEach(function (entity) {
            ...
            if (entity.BB && that.BB.collide(entity.BB)) {
                ...
                if ((entity instanceof BigTable || entity instanceof BigCouch || entity instanceof ChairRight || entity instanceof ChairLeft || entity instanceof PlainWall || entity instanceof SideWallLeft || entity instanceof SideWallRight || entity instanceof WallBottom)) {
                    ...
                    //debugging help
                    // console.log("lastBB.bottom: " + that.lastBB.bottom + ", that.lastBB.left: " + that.lastBB.left + ", that.lastBB.right: " + that.lastBB.right + ", that.lastBB.top: " + that.lastBB.top);
                    ...
                    //
                    //
                    // if(entity.BB.right <= that.lastBB.left){ // from right
                    //     that.x = entity.BB.right;
                    // }
                    // else if(entity.BB.left >= that.lastBB.right){ // from left
                    //     that.x = entity.BB.left - that.width * params.SCALE;
                    // }
                    // else if(entity.BB.bottom <= that.lastBB.top){ //from above
                    //     that.y = entity.BB.bottom - 40;
                    // }
                    // else if(entity.BB.top >= that.lastBB.bottom){ // from below
                    //     that.y = entity.BB.top - that.height * params.SCALE;
                    // } else {
                    //     console.log("nothing");
                    // }
                    // that.updateBB();
